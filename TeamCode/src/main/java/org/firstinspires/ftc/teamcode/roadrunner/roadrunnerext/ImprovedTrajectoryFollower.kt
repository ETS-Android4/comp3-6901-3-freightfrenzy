package org.firstinspires.ftc.teamcode.roadrunner.roadrunnerext
...
abstract class ImprovedTrajectoryFollower @JvmOverloads constructor(
    ...
    fun update(currentPose: Pose2d, currentRobotVel: Pose2d? = null): DriveSignal {
        if (RoadrunnerDriveConstants.admissibleError != this.admissibleError || RoadrunnerDriveConstants.admissibleTimeout != this.timeout) {
            this.admissibleError = RoadrunnerDriveConstants.admissibleError
            this.timeout = RoadrunnerDriveConstants.admissibleTimeout
        }
