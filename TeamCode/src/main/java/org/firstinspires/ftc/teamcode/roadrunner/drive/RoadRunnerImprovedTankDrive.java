 ...
 */
@Config
public class RoadRunnerImprovedTankDrive extends ImprovedTankDrive {
...
//    public RoadRunnerImprovedTankDrive(OpMode opMode, Pose2d pose2d) {
//        this(opMode, pose2d, OpModeType.NONE, Alliance.NONE);
//    }
//
//    public RoadRunnerImprovedTankDrive(OpMode opMode, OpModeType type, Alliance alliance) {
//        this(opMode, Context.robotPose, type, alliance);
//    }

//    public RoadRunnerImprovedTankDrive(OpMode opMode, OpModeType type) {
//        this(opMode, Context.robotPose, type, alliance);
//    }

    public RoadRunnerImprovedTankDrive(OpMode opMode) {
        this(opMode, new Pose2d(0, 0, 0)/*, OpModeType.NONE, Alliance.NONE*/);
    }

    public RoadRunnerImprovedTankDrive(OpMode opMode, Pose2d pose2d/*, OpModeType type, Alliance alliance*/) {
